...
annmodel = AnnModel(hidden_layers=[32, 128, 512, 1024], optimizer=tf.keras.optimizers.Adam(), tau=0.5)
...
##---- saving the model
save_model('toy_interpolator_v0.0.2_trial_2', model=model)
model.save('toy_interpolator_v0.0.2_trial_2.h5')
