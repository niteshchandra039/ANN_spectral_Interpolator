...
annmodel = AnnModel(hidden_layers=[32, 64], optimizer=tf.keras.optimizers.Adam(), tau=0.5)

t0 = time.time()
model = annmodel.train_model(X, y, var, epochs=10**5)
...
##---- saving the model
save_model('toy_interpolator_v0.0.2_trial_7', model=model)
model.save('toy_interpolator_v0.0.2_trial_7.h5')
